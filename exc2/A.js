...
function mouseClick(event){
    ...
    // Gera os pixels da reta entre os dois cliques
    const pontosBresenham = bresenham(
        pontosPixel[0], pontosPixel[1],
        pontosPixel[2], pontosPixel[3]
    );

    // Converte cada pixel da reta para o intervalo [-1, 1]
    pontos = [];
    ...
    // Substitui os vertices antigos pelos da nova linha
    ...
    // Cor precisa de um valor para cada pixel da reta
